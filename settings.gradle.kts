...
include(":feature:migrationremote")
include(":feature:migrationclient")
include(":feature:logger")
include(":feature:setdefault")
include(":xlang:lang_java")
include(":xlang:lang_kotlin")
include(":xlang:LangTest")
include(":xcompose:ComposeTest")
include(":xsummary:SummaryTest")
include(":core:lib-datastore")
include(":core:lib-network")
